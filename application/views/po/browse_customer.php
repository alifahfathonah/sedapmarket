		...
		<div class="col-lg-12">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body info">
					<form role="form" method="post" action="<?php echo site_url('browse/customers') ?>" id="frm2" name="frm2">
						<div class="form-group">
							...
							<?php echo (form_error("itm",'<p class="help-block">','</p>'))?form_error("itm",'<p class="help-block errors">','</p>'):'<p class="help-block">Enter Customer Name.</p>'; ?>		
						</div>
					</form>
				</div>
				<div class="panel-body info">
					<div class="alert alert-dismissable alert-info">
						...
						<form role="form" method="post" action="<?php echo site_url('browse/customers') ?>" id="frm1">
