				...
				<div class="panel-body info">
					<form role="form" method="post" action="<?php echo site_url('po/list') ?>" id="frm2" name="frm2">
						<div class="form-group">
							...
							<?php echo (form_error("itm",'<p class="help-block">','</p>'))?form_error("itm",'<p class="help-block errors">','</p>'):'<p class="help-block">Enter PO Name.</p>'; ?>		
						</div>
					</form>
				</div>
				<div class="panel-body info">
...
?> 	
								<tr>
									...
									<td><img src="<?php echo site_url("images/static/po.png") ?>" /></td>
								</tr>
<?php 
	}
} 
