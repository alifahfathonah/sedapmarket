		...
		<div class="col-lg-12">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Edit PO</h3>
				</div>
...
?>					
					<form role="form" method="post" action="<?php echo site_url('po/edit/'.$po_id) ?>" name="frm1">
						<div class="form-group">
							<label>PO Date</label>
							<input class="form-control datef" name="po_date" value="<?php echo $po['po_date'] ?>" readonly="readonly">
						...
						<div class="form-group">
							...
							<input class="form-control" name="po_no" value="<?php echo $po['po_no'] ?>" readonly="readonly">
						...
						<div class="form-group">
							...
							<input id="cust_id" name="cust_id" type="hidden" value="<?php echo $po['cust_id'] ?>">
							<input class="form-control cust_name" name="cust_fullname" value="<?php echo $po['cust_fullname'] ?>">
						...
						<div class="form-group">
							...
							<input name="ship_id" value="<?php echo $po['ship_id'] ?>" type="hidden">
							<input class="form-control ship_name" name="ship_name" value="<?php echo $po['ship_name'] ?>">
						...
						<div class="form-group">
							...
							<textarea class="form-control" rows="3" name="po_desc"><?php echo $po["po_desc"]?></textarea>
