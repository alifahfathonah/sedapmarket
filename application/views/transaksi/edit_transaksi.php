		...
		<div class="col-lg-12">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Edit Category</h3>
				</div>
...
<?php   } ?>					
					<form role="form" method="post" action="<?php echo site_url('category/edit/'.$cat_id) ?>">
						<div class="form-group">
							<label>Category Name</label>
							<input class="form-control datef" name="category_name" value="<?php echo $cat['category_name'] ?>">
						...
						<div class="form-group">
							...
							<textarea class="form-control" rows="3" name="category_desc"><?php echo $cat["category_desc"]?></textarea>
