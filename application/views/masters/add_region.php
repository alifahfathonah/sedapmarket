...
<?php   } ?>					
					<form role="form" method="post" action="<?php echo site_url('region/add') ?>">
						<div class="form-group">
							<label>Region Name</label>
							<input class="form-control" name="region_name" value="<?php echo set_value('region_name') ?>">
						...
						<div class="form-group">
							...
							<textarea class="form-control" rows="3" name="region_desc"><?php echo set_value("region_desc")?></textarea>
