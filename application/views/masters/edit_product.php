...
?>								
						...
						<div class="form-group">
							...
							<input class="form-control smallInput InputLine" name="product_stock" value="<?php echo $prod['product_stock'] ?>">
...
<?php if($unitlist) { 
		foreach($unitlist as $unit) { ?>
								<option value="<?php echo $unit["unit_id"] ?>" <?php echo ($prod["unit_id"]==$unit["unit_id"])?"selected='selected'":"" ?>><?php echo $unit["unit_name"] ?></option>
<?php 	}
	  }		
?>								
							</select>
						...
						<div class="form-group">
							...
							<input class="form-control smallInput  InputLine" name="product_disc" value="<?php echo $prod['product_disc'] ?>"> %
