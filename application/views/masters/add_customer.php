...
<?php   } ?>					
					<form role="form" method="post" action="<?php echo site_url('customer/add') ?>">
						...
						<div class="form-group">
							...
							<div class="radio">
								<label>
									<input type="radio" name="cust_type" value="D" <?php echo (!set_value('cust_type') || set_value('cust_type')=='D')?"checked='checked'":"" ?>> Distributor
								</label>	
							</div>	
							<div class="radio">
								<label>
									<input type="radio" name="cust_type" value="M" <?php echo (set_value('cust_type')=='M')?"checked='checked'":"" ?> > Modern Market 
								</label>
							</div>	
							<p class="help-block">Please choose Customer Type.</p>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input class="form-control" name="cust_npwp" value="<?php echo set_value("cust_npwp")?>">
...
<?php if($regionlist) { 
		foreach($regionlist as $region) { ?>
								<option value="<?php echo $region["region_id"] ?>" <?php echo (set_value("region_id")==$region["region_id"])?"selected='selected'":"" ?>><?php echo $region["region_name"] ?></option>
<?php 	}
	  }		
?>								
							</select>
						...
						<div class="form-group">
							...
							<div class="radio">
								<label>
									<input type="radio" name="cust_payby" value="I" <?php echo (!set_value('cust_payby') || set_value('cust_payby')=='I')?"checked='checked'":"" ?>> Company
								</label>	
							</div>	
							<div class="radio">
								<label>
									<input type="radio" name="cust_payby" value="C" <?php echo (set_value('cust_payby')=='C')?"checked='checked'":"" ?> > Customer 
								</label>
							</div>	
