...
<?php   } ?>					
					<form role="form" method="post" action="<?php echo site_url('production/edit/'.$prod_id) ?>" name="frm1">
						<div class="form-group">
							<label>Product Name</label>
							<input type="hidden" name="product_id" value="<?php echo $prod['product_id'] ?>">
							<input class="form-control product_name" name="product_name" value="<?php echo $prod['product_name'] ?>">
