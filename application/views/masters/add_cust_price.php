		...
		<div class="col-lg-12">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Add Region</h3>
				</div>
...
<?php   } ?>					
					<form role="form" method="post" action="<?php echo site_url('customer/price/add') ?>">
						<div class="form-group">
							...
							<input class="form-control" name="region_name" value="<?php echo set_value('product_name') ?>">
						...
						<div class="form-group">
							...
							<input class="form-control" name="disc1" value="<?php echo set_value('disc1') ?>">
						...
						<div class="form-group">
							...
							<input class="form-control" name="disc2" value="<?php echo set_value('disc2') ?>">
						...
						<div class="form-group">
							...
							<input class="form-control" name="disc3" value="<?php echo set_value('disc3') ?>">
						...
						<div class="form-group">
							...
							<textarea class="form-control" rows="3" name="region_desc"><?php echo set_value("price_desc"]?></textarea>
