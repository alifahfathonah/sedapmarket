		...
		<div class="col-lg-12">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Add Transcation</h3>
				</div>
...
<?php   } ?>					
					<form role="form" method="post" action="<?php echo site_url('transcation/add') ?>" name="frm1">
						<div class="form-group">
							<label>Transcation Date</label>
							<input class="form-control datef" name="trans_date" value="<?php echo set_value('trans_date') ?>" readonly="readonly">
						...
						<div class="form-group">
							...
							<input class="form-control" name="no_sj" value="<?php echo set_value('no_sj') ?>">
						...
						<div class="form-group">
							...
							<input class="form-control" name="no_mobil" value="<?php echo set_value('no_mobil') ?>">
						...
						<div class="form-group">
							...
							<input class="form-control" name="no_container" value="<?php echo set_value('no_container') ?>">
						...
						<div class="form-group">
							...
							<input class="form-control" name="no_seal" value="<?php echo set_value('no_seal') ?>">
						...
						<div class="form-group">
							...
							<textarea class="form-control" rows="3" name="trans_desc"><?php echo set_value("trans_desc")?></textarea>
