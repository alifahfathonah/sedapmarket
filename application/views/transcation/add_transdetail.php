...
<?php   } ?>					
					<form role="form" method="post" action="<?php echo site_url('transcation/detail/add/'.$trans_id."/".$detail_id) ?>" name="frm1">
						...
						<div class="form-group">
							...
							<input class="form-control" name="qty" value="<?php echo set_value('qty') ?>">
							<input type="hidden" name="unit_id" value="<?php echo set_value('unit_id') ?>">
							<input class="form-control" name="unit_name" value="<?php echo set_value('unit_name') ?>">
						...
						<div class="form-group">
							...
							<input class="form-control" name="product_extra_name" value="<?php echo set_value('product_extra_name') ?>">
						...
						<div class="form-group">
							<label>Quantity Extra</label>
							<input class="form-control" name="qty_extra" value="<?php echo set_value('qty_extra') ?>">
							<input type="hidden" name="unit_extra_id" value="<?php echo set_value('unit_extra_id') ?>">
							<input class="form-control" name="unit_extra_name" value="<?php echo set_value('unit_extra_name') ?>">
