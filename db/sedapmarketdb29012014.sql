...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 29, 2014 at 05:10 PM
...
INSERT INTO `customers` (`cust_id`, `cust_type`, `cust_fullname`, `cust_address`, `cust_city`, `cust_state`, `cust_phonenumber`, `cust_faxnumber`, `cust_mobilenumber`, `cust_emailaddress`, `cust_regdate`) VALUES
(1, 'M', 'Andre Sutarko', 'jhjhjh', 'sss', 'sss', 'hjhjh', '', '', '', '2014-01-28'),
(2, '', 'sss', 'ss', '', '', 'ssss', '', '', '', '2014-01-28'),
(6, '', 'ww', 'w', 'ww', 'ww', 'www', '', '', '', '2014-01-28'),
(8, 'M', 'aaa', 'aaaa', 'aa', 'aaa', 'aaa', '', '', '', '2014-01-29');
...
INSERT INTO `products` (`product_id`, `category_id`, `product_name`, `product_kemasan`, `product_stock`, `product_price`) VALUES
(1, 3, 'kkjkl', 'Yes', 10, 10000);
...
(1, 'andre@asutarko.com', 'e158843af981dc589768882974440a59a90c616d', 'Admin', '2014-01-29 12:09:07', 1);
