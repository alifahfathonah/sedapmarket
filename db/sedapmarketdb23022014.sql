...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2014 at 02:47 PM
...
('FORMATDATE', 'Format Date', 'M d, Y H:i:s', 'Format Date', 5),
...
INSERT INTO `po` (`po_id`, `po_date`, `po_no`, `cust_id`, `ship_id`, `po_desc`) VALUES
(2, '2014-02-20', 'swwwss', 2, 1, 'as1'),
(3, '2014-02-21', '66544', 2, 1, '');
...
INSERT INTO `po_detail` (`detail_id`, `po_id`, `product_id`, `qty`, `unit_id`, `price`, `disc`, `subtotal`) VALUES
(1, 2, 1, 10, 1, 15000, 1.50, 147750),
(2, 2, 2, 10, 1, 250000, 0.25, 2493750);
...
INSERT INTO `shipper` (`ship_id`, `ship_name`, `ship_desc`) VALUES
(1, 'aaaa2', '');
...
INSERT INTO `transcation` (`transcation_id`, `trans_date`, `no_sj`, `no_mobil`, `no_container`, `no_seal`, `trans_desc`) VALUES
(4, '2014-02-13', 'aaa', '1', '2', '3', '4');

-- --------------------------------------------------------

--
-- Table structure for table `transcation_detail`
--

DROP TABLE IF EXISTS `transcation_detail`;
CREATE TABLE IF NOT EXISTS `transcation_detail` (
  `detail_id` int(11) NOT NULL AUTO_INCREMENT,
  `transcation_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `qty` int(11) NOT NULL DEFAULT '0',
  `unit_id` int(11) NOT NULL,
  `product_extra_id` int(11) NOT NULL,
  `qty_extra` int(11) NOT NULL DEFAULT '0',
  `unit_extra_id` int(11) NOT NULL,
  PRIMARY KEY (`detail_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10 ;

--
-- Dumping data for table `transcation_detail`
--

INSERT INTO `transcation_detail` (`detail_id`, `transcation_id`, `product_id`, `qty`, `unit_id`, `product_extra_id`, `qty_extra`, `unit_extra_id`) VALUES
(9, 4, 2, 4, 1, 2, 2, 1),
(8, 4, 1, 10, 1, 2, 5, 1);
...
(1, 'andre@asutarko.com', 'e158843af981dc589768882974440a59a90c616d', 'Admin', '2014-02-23 19:36:31', 1),
